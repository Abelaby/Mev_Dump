        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    pools = poolData.data.pools.slice(0, 900);
...
function bellmanFord(graph, nodes) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var worker = new worker_threads_1.Worker('./bellmanFordWorker.ts');
                    worker.postMessage({ graph: graph, nodes: nodes });
                    worker.on('message', function (arbitrageOpportunity) {
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var graphData, worker, arbitrageOpportunity;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (worker_threads_1.isMainThread) {
                        worker = new worker_threads_1.Worker('./bellmanFordWorker.js');
                        worker.on('message', function (arbitrageOpportunity) {
                        ...
                        arbitrageOpportunity = bellmanFord(worker_threads_1.workerData.graph, worker_threads_1.workerData.nodes);
                        worker_threads_1.parentPort.postMessage(arbitrageOpportunity);
                    }
                    return [2 /*return*/];
            }
        });
